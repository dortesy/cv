...
function checkForm(form1) {
  ...
  if($form.find(".service").hasClass("required")) {
    if(!name) {
      $form.find(".service").addClass("red");
      $form.find(".service").attr("data", error1);
      checker = false;
    } else {
      $form.find(".service").removeClass('red');
    }
  }

    if($form.find(".country").hasClass("required")) {
    if(!country) {
      $form.find(".country").addClass("red");
      $form.find(".country").attr("data", error1);
      checker = false;
    } else {
      $form.find(".country").removeClass('red');
    }
  }

    if($form.find(".invest").hasClass("required")) {
    if(!invest) {
      $form.find(".invest").addClass("red");
      $form.find(".invest").attr("data", error1);
      checker = false;
    } else {
      $form.find(".invest").removeClass('red');
    }
  }  
